...
routes['/quote_detail'] = 'Logins#quote_details'
routes['/user/<int:id>'] = 'Logins#user_details'
routes['POST']['/quote'] = 'Logins#quotes'
routes['/fav/<int:quote_id>'] = 'Logins#fav'
routes['/delete/<int:quote_id>'] = 'Logins#delete'
